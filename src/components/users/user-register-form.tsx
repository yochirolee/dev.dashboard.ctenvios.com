   ...
   return (
      <Dialog open={open} onOpenChange={setOpen}>
         ...
         <DialogContent className="max-w-md">
            ...
            <UserRegisterFormContent agencyId={agencyId} onClose={() => setOpen(false)} />
         </DialogContent>
      </Dialog>
   );
}

function UserRegisterFormContent({ agencyId, onClose }: { agencyId: number; onClose: () => void }) {
   ...
   return (
      <Form {...form}>
         <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            {registerUser.error && <Alert variant="destructive">{registerUser.error.message}</Alert>}
         </form>
      </Form>
   );
}
