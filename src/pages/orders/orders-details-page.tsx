...
export default function OrdersDetailsPage() {
   ...
   const total_weight = invoice?.items.reduce((acc: number, item: any) => acc + item?.weight || 0, 0);
   ...
   return invoice ? (
      <div className="space-y-6 ">
            ...
            <div className="flex flex-col gap-2">
               <div className="flex items-center gap-2">
                  <div className="flex items-center gap-2">
                     ...
                     <div>
                        <div>
                           <span className="text-sm mr-2">{invoice?.service?.provider?.name}</span>
                           <Badge
         ...
         <Card className="p-4 print:shadow-none bg-card print:bg-white print:py-0 print:text-gray-500">
               ...
               <TableBody>
                  {invoice?.items.map((item: any, index: number) => (
                     <TableRow key={index}>
                        ...
                        <TableCell className={`text-right ${item?.rate_in_cents === 0 ? "text-muted-foreground" : ""}`}>
            ...
            <div className="print:hidden mx-auto w-full xl:w-1/6">
               {invoice?.payment_status === "PENDING" || invoice?.payment_status === "PARTIALLY_PAID" ? (
