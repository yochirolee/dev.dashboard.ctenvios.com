            ...
            {isSetupMode ? (
               <div className="max-w-2xl mx-auto mt-10">
                  <Card className="border-primary/20 shadow-lg shadow-primary/5">
                     <CardHeader>
                        <CardTitle className="text-2xl">Despachos</CardTitle>
                        <CardDescription>Recibir sin Despacho</CardDescription>
                     </CardHeader>
                     <CardContent className="space-y-6">
                        <div className="space-y-2">
                           <label className="text-sm font-medium">No de Despacho</label>
                           <Input
                              value={manifestId}
                        ...
                        <div className="relative">
                           ...
                           <div className="relative flex justify-center text-xs uppercase">
                              <span className="bg-card px-2 text-muted-foreground">Recibir sin Despacho</span>
                           </div>
                        </div>

                        <Button onClick={() => setIsSetupMode(false)} className="w-full">
                           Recibir
                        </Button>
                     </CardContent>
                  </Card>
